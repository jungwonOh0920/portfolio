...
const resume = () => {
    return (
        <div className='resume-container max-w-5xl mx-auto mt-4 px-4'>
            ...
            <div className='column2 project'>
                <div className='flex flex-col'>
                    ...
                    <div className='flex flex-row justify-between text-xs'>
                        <p>09/2022 - Present</p>
                        <div className='flex flex-col link-container'>
                            <Link href='https://github.com/jungwonOh0920/tmdb' target='_blank' rel="noopenner noreferrer">Source code: github.com/jungwonOh0920/tmdb</Link>
                            <Link href='https://jayohtmdb.netlify.app/' target='_blank'>Demo: jayohtmdb.netlify.app</Link>
                        </div>
                    </div>
                    <ul className='description-list'>
